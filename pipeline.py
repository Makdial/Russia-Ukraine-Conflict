...
KOBO_CSV_URL = "https://kf.kobotoolbox.org/api/v2/assets/asTM9uT29opjQze9W7juZs/export-settings/es8nfQ42U3Pq8k2yJqVZPf8/data.csv"
...
if response.status_code == 200:
    ...
    cur.execute(f"""
        CREATE TABLE {schema_name}.{table_name} (
            ...
            area_occupied FLOAT,
            Total_Soldier_Casualties FLOAT
        );       
    """)
    print(id)
